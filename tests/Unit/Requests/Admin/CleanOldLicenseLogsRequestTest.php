...
use App\Http\Requests\Admin\CleanOldLicenseLogsRequest;
use App\Models\User;
...
/**
 * Test suite for CleanOldLicenseLogsRequest.
 *
 * This test suite covers all validation rules, authorization,
 * and data preparation for license verification log cleanup requests.
 */
class CleanOldLicenseLogsRequestTest extends TestCase
{
    use RefreshDatabase;
    ...
    {
        $request = new CleanOldLicenseLogsRequest();
    ...
    public function prepares_data_for_validation()
    {
        ...
        $this->assertEquals(90, $request->input('days'));
    }

 ...
 *
 * This controller handles knowledge base operations including article
 * management, category browsing, and search functionality with enhanced
 * security measures and proper error handling.
 *
 * Features:
 * - Knowledge base article management (CRUD operations)
...
class KbController extends Controller
{
     ...
     *
     * Shows knowledge base homepage with categories and recent articles
     * with comprehensive error handling and security measures.
     *
     * @return View The knowledge base index view
     *
     ...
     *
     * Displays article creation form with category selection and
     * comprehensive error handling.
     *
     * @return View The article creation view
     *
     * @throws Exception When database operations fail
     *
     * @example
     * // Access article creation form:
     * GET /kb/create
     *
     * // Returns view with:
     ...
     * POST /kb
     * {
     *     "title": "How to install the product",
     *     "slug": "how-to-install",
     ...
     *
     * Shows detailed article information with category relationship
     * and comprehensive error handling.
     *
     * @param  KbArticle  $article  The article instance
     *
     * @return View The article detail view
     *
     * @throws Exception When database operations fail
     *
     * @example
     * // Access specific article:
     * GET /kb/articles/how-to-install
     *
     * // Returns view with:
     * // - Article details
     ...
     *
     * Displays article editing form with category selection and
     * comprehensive error handling.
     *
     * @param  KbArticle  $article  The article instance
     *
     * @return View The article editing view
     *
     * @throws Exception When database operations fail
     *
     * @example
     * // Access article editing form:
     * GET /kb/articles/1/edit
     *
     * // Returns view with:
     * // - Article data
     * // - All available categories
     ...
     *
     * Updates article information with comprehensive validation,
     * input sanitization, and error handling.
     *
     ...
     *
     * Deletes article with comprehensive error handling and
     ...
     *
     * Performs article search with comprehensive validation,
     * input sanitization, and error handling.
     *
     ...
     *
     * Displays articles belonging to a specific category with
     * comprehensive error handling and security measures.
     *
     * @param  KbCategory  $category  The category instance
     *
     * @return View The category articles view
     *
     * @throws Exception When database operations fail
     *
     * @example
     * // Access category articles:
     * GET /kb/categories/installation
     *
     * // Returns view with:
     * // - Category information
     ...
     *
     * @return string The validated query
     */

...
class NewPasswordController extends Controller
{
     ...
     *
     * Shows the password reset form to users who have clicked on
     * a password reset link from their email.
     *
     * @param  Request  $request  The current request containing reset token
     *
     ...
     *
     * Validates the reset token and new password, then updates the user's
     * password if the token is valid. Fires a password reset event upon
     * successful password update.
     *
     * @param  Request  $request  The password reset request
     *

 ...
 * This unified request class handles validation for both creating and updating * product updates with comprehensive security measures and input sanitization. *
 * Features: * - Unified validation for both store and update operations * - XSS protection and input sanitization * - File upload validation with security checks * - Custom validation messages for better user experience * - Proper type hints and return types * - Security validation rules (XSS protection, SQL injection prevention) * - Version validation and file security * - Update type and status management */
class ProductUpdateRequest extends FormRequest
{
    ...
    /**   * Get the product ID safely. *   * @return int|null */

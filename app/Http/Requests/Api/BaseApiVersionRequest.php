...
/**
 * Base API Version Request with enhanced security.
 *
 * This base request class handles common validation for version-related API operations
 * with comprehensive security measures and input sanitization.
 */
abstract class BaseApiVersionRequest extends FormRequest
{
    /**

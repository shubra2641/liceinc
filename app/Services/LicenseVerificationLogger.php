 ...
 * A comprehensive service for logging license verification attempts with * enhanced security measures, input validation, and comprehensive error handling. *
 * Features: * - Secure license verification logging * - Purchase code hashing for security * - Request information tracking * - Statistics and analytics * - Suspicious activity detection * - Enhanced error handling and logging * - Input validation and sanitization * - Comprehensive security measures * - Clean code structure with no duplicate patterns * - Proper type hints and return types */
class LicenseVerificationLogger
{
    /**   * Log license verification attempt with enhanced security. *   * Logs license verification attempts with comprehensive validation, * sanitization, and security measures including purchase code hashing. *   * @param string $purchaseCode The purchase code to log * @param string $domain The domain being verified * @param bool $isValid Whether the verification was successful * @param string $message The verification message * @param  array|null  $responseData  Additional response data * @param string $source The verification source (install, api, admin) * @param  Request|null  $request  The HTTP request object * @param  string|null  $errorDetails  Additional error details *   * @return LicenseVerificationLog The created log entry *   * @throws \InvalidArgumentException When parameters are invalid *   * @version 1.0.6 *   *   *   *   */
    ...
    /**   * Get verification statistics with enhanced security. *   * Retrieves comprehensive verification statistics with input validation * and sanitization for the specified time period. *   * @param int $days Number of days to include in statistics *   * @return array Statistics array with counts and metrics *   * @throws \InvalidArgumentException When days parameter is invalid *   * @version 1.0.6 *   *   *   *   */
    ...
    /**   * Get suspicious activity with enhanced security. *   * Identifies suspicious activity patterns with input validation * and comprehensive error handling. *   * @param int $hours Number of hours to look back * @param int $minAttempts Minimum number of attempts to consider suspicious *   * @return array Array of suspicious activity records *   * @throws \InvalidArgumentException When parameters are invalid *   * @version 1.0.6 *   *   *   *   */
    /**   * @return array<string, mixed> */
    ...
    /**   * Get recent verification attempts with enhanced security. *   * Retrieves recent verification attempts with input validation * and comprehensive error handling. *   * @param int $limit Maximum number of attempts to retrieve *   * @return Collection Collection of recent verification attempts *   * @throws \InvalidArgumentException When limit is invalid *   * @version 1.0.6 *   *   *   *   */
    ...
    /**   * Clean old logs with enhanced security. *   * Removes old log entries with input validation and comprehensive * error handling for data cleanup operations. *   * @param int $days Number of days to keep logs *   * @return int Number of deleted log entries *   * @throws \InvalidArgumentException When days parameter is invalid *   * @version 1.0.6 *   *   *   *   */
    ...
    /**   * Validate and sanitize domain. *   * Validates the domain and returns a sanitized version * with proper security measures. *   * @param string $domain The domain to validate *   * @return string The validated and sanitized domain *   * @throws \InvalidArgumentException When domain is invalid *   * @version 1.0.6 *   *   *   *   */
    ...
    /**   * Validate and sanitize verification source. *   * Validates the verification source and returns a sanitized version * with proper security measures. *   * @param string $source The source to validate *   * @return string The validated and sanitized source *   * @throws \InvalidArgumentException When source is invalid *   * @version 1.0.6 *   *   *   *   */
    ...
    /**   * Get validated IP address from request. *   * Extracts and validates IP address from request with proper * security measures and fallback handling. *   * @param  Request|null  $request  The HTTP request object *   * @return string The validated IP address *   * @version 1.0.6 *   *   *   *   */
    ...
    /**   * Get validated user agent from request. *   * Extracts and validates user agent from request with proper * security measures and fallback handling. *   * @param  Request|null  $request  The HTTP request object *   * @return string The validated user agent *   * @version 1.0.6 *   *   *   *   */
    ...
    /**   * Validate days parameter. *   * Validates the days parameter for statistics and cleanup operations. *   * @param int $days The days parameter to validate *   * @return int The validated days parameter *   * @throws \InvalidArgumentException When days is invalid *   * @version 1.0.6 *   *   *   *   */
    ...
    /**   * Validate hours parameter. *   * Validates the hours parameter for suspicious activity detection. *   * @param int $hours The hours parameter to validate *   * @return int The validated hours parameter *   * @throws \InvalidArgumentException When hours is invalid *   * @version 1.0.6 *   *   *   *   */
    ...
    /**   * Validate minimum attempts parameter. *   * Validates the minimum attempts parameter for suspicious activity detection. *   * @param int $minAttempts The minimum attempts parameter to validate *   * @return int The validated minimum attempts parameter *   * @throws \InvalidArgumentException When minAttempts is invalid *   * @version 1.0.6 *   *   *   *   */
    ...
    /**   * Validate limit parameter. *   * Validates the limit parameter for data retrieval operations. *   * @param int $limit The limit parameter to validate *   * @return int The validated limit parameter *   * @throws \InvalidArgumentException When limit is invalid *   * @version 1.0.6 *   *   *   *   */
    ...
    /**   * Determine status based on validation results. *   * Determines the appropriate status based on validation results * and error details with proper validation. *   * @param bool $isValid Whether the verification was successful * @param  string|null  $errorDetails  Additional error details *   * @return string The determined status *   * @version 1.0.6 */

...
<div class="container-fluid products-form">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h1 class="h3 mb-1 text-dark">
                                ...
                                <?php echo e(trans('app.Edit Ticket Category')); ?>

                            </h1>
                            <p class="text-muted mb-0"><?php echo e($ticketCategory->name); ?></p>
                        </div>
                        <div>
    ...
    <form method="post" action="<?php echo e(route('admin.ticket-categories.update', $ticketCategory)); ?>" class="needs-validation" novalidate>
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                       id="name" name="name" value="<?php echo e(old('name', $ticketCategory->name)); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                                       id="slug" name="slug" value="<?php echo e(old('slug', $ticketCategory->slug)); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                                      ...
                                      placeholder="<?php echo e(trans('app.Enter Category Description')); ?>"><?php echo e(old('description', $ticketCategory->description)); ?></textarea>
                            <div class="form-text">
                                <i class="fas fa-info-circle me-1"></i>
...
unset($__errorArgs, $__bag); ?>" 
                                           id="color" name="color" value="<?php echo e(old('color', $ticketCategory->color)); ?>" required>
                                    <input type="text" class="form-control" id="color-text" 
                                           value="<?php echo e(old('color', $ticketCategory->color)); ?>" readonly>
                                </div>
                                <div class="form-text">
                                    <i class="fas fa-info-circle me-1"></i>
...
unset($__errorArgs, $__bag); ?>" 
                                       id="sort_order" name="sort_order" value="<?php echo e(old('sort_order', $ticketCategory->sort_order)); ?>" 
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-check form-switch mb-3">
                            ...
                            <input class="form-check-input" type="checkbox" id="is_active" name="is_active" value="1"
                                   <?php echo e(old('is_active', $ticketCategory->is_active) ? 'checked' : ''); ?>>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-check form-switch">
                                    ...
                                    <input class="form-check-input" type="checkbox" id="requires_login" name="requires_login" value="1"
                                           <?php echo e(old('requires_login', $ticketCategory->requires_login) ? 'checked' : ''); ?>>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-check form-switch">
                                    ...
                                    <input class="form-check-input" type="checkbox" id="requires_valid_purchase_code" name="requires_valid_purchase_code" value="1"
                                           <?php echo e(old('requires_valid_purchase_code', $ticketCategory->requires_valid_purchase_code) ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" 
                                       id="meta_title" name="meta_title" value="<?php echo e(old('meta_title', $ticketCategory->meta_title)); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                                       id="meta_keywords" name="meta_keywords" value="<?php echo e(old('meta_keywords', $ticketCategory->meta_keywords)); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                                      ...
                                      maxlength="500" placeholder="<?php echo e(trans('app.SEO Description Placeholder')); ?>"><?php echo e(old('meta_description', $ticketCategory->meta_description)); ?></textarea>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="text-center">
                            <div id="category-preview" class="p-3 rounded category-preview" data-color="<?php echo e($ticketCategory->color); ?>">
                                <i class="<?php echo e($ticketCategory->icon ?? 'fas fa-ticket-alt'); ?> fs-1 mb-2"></i>
                                <h5 id="preview-name"><?php echo e($ticketCategory->name); ?></h5>
                                <p id="preview-description" class="mb-0 small"><?php echo e($ticketCategory->description ?: trans('app.Category Description')); ?></p>
                            </div>
                        ...
                        <div class="row text-center">
                            <div class="col-6 mb-3">
                                <div class="stats-card">
                                    <h4 class="text-primary"><?php echo e($ticketCategory->tickets()->count()); ?></h4>
                                    <p class="text-muted small mb-0"><?php echo e(trans('app.Tickets')); ?></p>
                                </div>
                            </div>
                            <div class="col-6 mb-3">
                                <div class="stats-card">
                                    <h4 class="text-success"><?php echo e($ticketCategory->tickets()->withCount('replies')->get()->sum('replies_count')); ?></h4>
                                    <p class="text-muted small mb-0"><?php echo e(trans('app.Replies')); ?></p>
                                </div>
                            </div>
                            <div class="col-6 mb-3">
                                <div class="stats-card">
                                    <h4 class="text-info"><?php echo e($ticketCategory->created_at->format('M Y')); ?></h4>
                                    <p class="text-muted small mb-0"><?php echo e(trans('app.Created')); ?></p>
                                </div>
                            </div>
                            <div class="col-6 mb-3">
                                <div class="stats-card">
                                    <h4 class="text-warning"><?php echo e($ticketCategory->updated_at->format('M Y')); ?></h4>
...
unset($__errorArgs, $__bag); ?>" 
                                   id="icon" name="icon" value="<?php echo e(old('icon', $ticketCategory->icon ?? 'fas fa-ticket-alt')); ?>" 
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="text-center">
                            <div id="icon-preview" class="fs-1 text-primary">
                                <i class="<?php echo e($ticketCategory->icon ?? 'fas fa-ticket-alt'); ?>"></i>
                            </div>
...
unset($__errorArgs, $__bag); ?>" 
                                ...
                                <option value="low" <?php echo e(old('priority', $ticketCategory->priority ?? 'medium') == 'low' ? 'selected' : ''); ?>>
                                    <i class="fas fa-arrow-down text-success me-1"></i><?php echo e(trans('app.Low')); ?>

                                </option>
                                <option value="medium" <?php echo e(old('priority', $ticketCategory->priority ?? 'medium') == 'medium' ? 'selected' : ''); ?>>
                                    <i class="fas fa-minus text-warning me-1"></i><?php echo e(trans('app.Medium')); ?>

                                </option>
                                <option value="high" <?php echo e(old('priority', $ticketCategory->priority ?? 'medium') == 'high' ? 'selected' : ''); ?>>
                                    <i class="fas fa-arrow-up text-danger me-1"></i><?php echo e(trans('app.High')); ?>

                                </option>
                                <option value="urgent" <?php echo e(old('priority', $ticketCategory->priority ?? 'medium') == 'urgent' ? 'selected' : ''); ?>>
        ...
        <div class="col-12">
            <div class="card border-danger">
                ...
                <div class="card-body">
                    ...
                    <form method="post" action="<?php echo e(route('admin.ticket-categories.destroy', $ticketCategory)); ?>" 
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp1\htdocs\my-logos\resources\views\admin\ticket-categories\edit.blade.php ENDPATH**/ ?>
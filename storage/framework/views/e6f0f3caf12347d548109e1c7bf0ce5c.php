...
<div class="card mb-4">
    ...
    <div class="card-body">
        <div class="row align-items-center">
            ...
            <div class="col-md-4 text-end">
                <button id="update-system-btn" class="btn btn-warning btn-lg" data-version="<?php echo e($versionStatus['latest_version']); ?>">
                    <i class="fas fa-download me-2"></i>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\my-logos\resources\views/admin/updates/index.blade.php ENDPATH**/ ?>
...
unset($__errorArgs, $__bag); ?>" 
                                    ...
                                    <option value="custom" <?php echo e(old('license_id', $invoice->license_id === null ? 'custom' : $invoice->license_id) == 'custom' ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                ...
                <?php if($invoice->license_id === null || old('license_id') == 'custom'): ?>
...
unset($__errorArgs, $__bag); ?>" 
                                    ...
                                    <option value="one_time" <?php echo e(old('custom_invoice_type', $customData['custom_invoice_type'] ?? '') == 'one_time' ? 'selected' : ''); ?>>
                                        <?php echo e(trans('app.One-time Payment')); ?>

                                    </option>
                                    <option value="monthly" <?php echo e(old('custom_invoice_type', $customData['custom_invoice_type'] ?? '') == 'monthly' ? 'selected' : ''); ?>>
                                        <?php echo e(trans('app.Monthly')); ?>

                                    </option>
                                    <option value="quarterly" <?php echo e(old('custom_invoice_type', $customData['custom_invoice_type'] ?? '') == 'quarterly' ? 'selected' : ''); ?>>
                                        <?php echo e(trans('app.Quarterly')); ?>

                                    </option>
                                    <option value="semi_annual" <?php echo e(old('custom_invoice_type', $customData['custom_invoice_type'] ?? '') == 'semi_annual' ? 'selected' : ''); ?>>
                                        <?php echo e(trans('app.Semi-Annual')); ?>

                                    </option>
                                    <option value="annual" <?php echo e(old('custom_invoice_type', $customData['custom_invoice_type'] ?? '') == 'annual' ? 'selected' : ''); ?>>
                                        <?php echo e(trans('app.Annual')); ?>

                                    </option>
                                    <option value="custom_recurring" <?php echo e(old('custom_invoice_type', $customData['custom_invoice_type'] ?? '') == 'custom_recurring' ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" 
                                       ...
                                       value="<?php echo e(old('custom_product_name', $customData['custom_product_name'] ?? '')); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                                       ...
                                       value="<?php echo e(old('expiration_date', $customData['expiration_date'] ?? '')); ?>">
                                <div class="form-text">

...
<div class="container-fluid products-form">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <p class="text-muted mb-0"><?php echo e(trans('app.Design and customize professional email templates
                                for your system')); ?></p>
                        </div>
                        <div>
    ...
    <form method="POST" action="<?php echo e(route('admin.email-templates.store')); ?>" class="needs-validation" novalidate>
        <?php echo csrf_field(); ?>
                                ...
                                <div class="d-flex gap-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="is_active" value="1"
                                            id="is_active_yes" <?php echo e(old('is_active', true) ? 'checked' : ''); ?>>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="is_active" value="0"
                                            id="is_active_no" <?php echo e(old('is_active')==='0' ? 'checked' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" id="body" name="body"
                                    ...
                                    placeholder="<?php echo e(trans('app.Enter your email content here...')); ?>"><?php echo e(old('body')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"
                                    ...
                                    placeholder="<?php echo e(trans('app.Brief description of this template...')); ?>"><?php echo e(old('description')); ?></textarea>
                    ...
                    <div class="card-body">
                        <div class="d-grid gap-2">
                            <button type="submit" class="btn btn-primary">
                                ...
                                <?php echo e(trans('app.Create Template')); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp1\htdocs\my-logos\resources\views\admin\email-templates\create.blade.php ENDPATH**/ ?>
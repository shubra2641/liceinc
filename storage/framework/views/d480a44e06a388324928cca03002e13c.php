        ...
        <div class="admin-section-header">
            ...
            <div class="admin-section-actions">
                <button class="admin-btn admin-btn-outline-primary admin-btn-sm" data-action="export-detailed-reports">
                    <i class="fas fa-download me-1"></i><?php echo e(trans('app.Export All')); ?>
                ...
                <div class="col-lg-6">
                    <div class="admin-card table-card">
                        <div class="admin-section-content">
                            <div class="d-flex align-items-center justify-content-between">
                                <h3 class="admin-card-title">
                                    <i class="fas fa-history me-2"></i><?php echo e(trans('app.user_activity_log')); ?>
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <span class="admin-badge admin-badge-info"><?php echo e($recentActivities->count()); ?> <?php echo e(trans('app.activities')); ?></span>
                                </div>
                            </div>
                        </div>
                        <div class="admin-card-content">
                ...
                <div class="col-lg-12">
                    <div class="admin-card table-card">
                        <div class="admin-section-content">
                            <div class="d-flex align-items-center justify-content-between">
                                <h3 class="admin-card-title">
                                    <i class="fas fa-chart-line me-2"></i><?php echo e(trans('app.financial_summary')); ?>
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <span class="admin-badge admin-badge-success"><?php echo e(trans('app.revenue_analysis')); ?></span>
                                </div>
                            </div>
                        </div>
                        <div class="admin-card-content">
                            <div class="row g-3">
                                <div class="col-md-3">
                                    <div class="text-center p-3 border rounded">
                                        <h4 class="text-success mb-1">$<?php echo e(number_format($invoiceStatusTotals['paid'] ?? 0, 2)); ?></h4>
                                        <small class="text-muted"><?php echo e(trans('app.total_paid')); ?></small>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="text-center p-3 border rounded">
                                        <h4 class="text-warning mb-1">$<?php echo e(number_format($invoiceStatusTotals['pending'] ?? 0, 2)); ?></h4>
                                        <small class="text-muted"><?php echo e(trans('app.pending_amount')); ?></small>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="text-center p-3 border rounded">
                                        <h4 class="text-danger mb-1">$<?php echo e(number_format($invoiceStatusTotals['overdue'] ?? 0, 2)); ?></h4>
                                        <small class="text-muted"><?php echo e(trans('app.overdue_amount')); ?></small>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="text-center p-3 border rounded">
                                        <h4 class="text-info mb-1"><?php echo e($totalLicenses); ?></h4>
                                        <small class="text-muted"><?php echo e(trans('app.total_licenses')); ?></small>
                                    </div>
                                </div>
                            </div>
                        </div>

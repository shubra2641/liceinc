...
<?php $__env->startSection('title', 'Edit KB Article'); ?>
...
<div class="container-fluid products-form">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h1 class="h3 mb-1 text-dark">
                                ...
                                <?php echo e(trans('app.Edit KB Article')); ?>

                            </h1>
                            <p class="text-muted mb-0"><?php echo e($article->title); ?></p>
                        </div>
                        <div>
    ...
    <form method="post" action="<?php echo e(route('admin.kb-articles.update', $article)); ?>" enctype="multipart/form-data" class="needs-validation" novalidate>
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                    ...
                                    <option value="<?php echo e($id); ?>" 
                                        <?php echo e(old('kb_category_id', $article->kb_category_id) == $id ? 'selected' : ''); ?>>
                                        <?php echo e($name); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                       id="slug" name="slug" value="<?php echo e(old('slug', $article->slug)); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                                   id="title" name="title" value="<?php echo e(old('title', $article->title)); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                                      ...
                                      placeholder="<?php echo e(trans('app.Brief summary of article')); ?>"><?php echo e(old('excerpt', $article->excerpt)); ?></textarea>
                            <div class="form-text">
                                <i class="fas fa-info-circle me-1"></i>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <label class="form-label"><?php echo e(trans('app.Current Featured Image')); ?></label>
                        ...
                        <div class="mb-3">
                            <label for="image" class="form-label">
                                ...
                                <?php echo e($article->image ? trans('app.Change Featured Image') : trans('app.Featured Image')); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                      ...
                                      placeholder="<?php echo e(trans('app.Enter Article Content')); ?>" required><?php echo e(old('content', $article->content)); ?></textarea>
                            <div class="form-text">
                                <i class="fas fa-info-circle me-1"></i>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-check form-switch mb-3">
                            ...
                            <label class="form-check-label" for="is_published">
                                ...
                                <?php echo e(trans('app.Published')); ?>
                    ...
                    <div class="card-body">
                        <div class="form-check form-switch mb-3">
                            <input class="form-check-input" type="checkbox" id="requires_serial" name="requires_serial" value="1"
                                   <?php echo e(old('requires_serial', $article->requires_serial) ? 'checked' : ''); ?>>
                        ...
                        <div id="serial-fields" class="<?php echo e(old('requires_serial', $article->requires_serial) ? 'visible-field' : 'hidden-field'); ?>">
                            <div class="mb-3">
...
unset($__errorArgs, $__bag); ?>" 
                                       id="serial" name="serial" value="<?php echo e(old('serial', $article->serial)); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                                          ...
                                          placeholder="<?php echo e(trans('app.Message shown when serial required')); ?>"><?php echo e(old('serial_message', $article->serial_message)); ?></textarea>
                                <div class="form-text">
                                    <i class="fas fa-info-circle me-1"></i>
...
unset($__errorArgs, $__bag); ?>" 
                                       id="meta_title" name="meta_title" value="<?php echo e(old('meta_title', $article->meta_title)); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                                       id="meta_keywords" name="meta_keywords" value="<?php echo e(old('meta_keywords', $article->meta_keywords)); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                                      ...
                                      maxlength="500" placeholder="<?php echo e(trans('app.SEO Description Placeholder')); ?>"><?php echo e(old('meta_description', $article->meta_description)); ?></textarea>
                    ...
                    <div class="card-body">
                        <div class="text-center">
                            <div id="article-preview" class="p-3 rounded border">
                                ...
                                <h5 id="preview-title"><?php echo e($article->title); ?></h5>
                                <p id="preview-excerpt" class="text-muted small mb-0"><?php echo e($article->excerpt ?: trans('app.Article Excerpt')); ?></p>
                            </div>
                        ...
                        <div class="row text-center">
                            <div class="col-6 mb-3">
                                <div class="stats-card">
                                    <h4 class="text-primary"><?php echo e($article->views ?? 0); ?></h4>
                                    <p class="text-muted small mb-0"><?php echo e(trans('app.Views')); ?></p>
                                </div>
                            </div>
                            <div class="col-6 mb-3">
                                <div class="stats-card">
                                    <h4 class="text-success"><?php echo e($article->likes ?? 0); ?></h4>
                                    <p class="text-muted small mb-0"><?php echo e(trans('app.Likes')); ?></p>
                                </div>
                            </div>
                            <div class="col-6 mb-3">
                                <div class="stats-card">
                                    <h4 class="text-info"><?php echo e($article->created_at->format('M Y')); ?></h4>
                                    <p class="text-muted small mb-0"><?php echo e(trans('app.Created')); ?></p>
                                </div>
                            </div>
                            <div class="col-6 mb-3">
                                <div class="stats-card">
                                    <h4 class="text-warning"><?php echo e($article->updated_at->format('M Y')); ?></h4>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-check form-switch mb-3">
                            <input class="form-check-input" type="checkbox" id="allow_comments" name="allow_comments" value="1"
                                   <?php echo e(old('allow_comments', $article->allow_comments ?? true) ? 'checked' : ''); ?>>
                ...
                <div class="card mb-4">
                    <div class="card-header bg-primary text-white">
                        <h5 class="card-title mb-0">
                            ...
                            <?php echo e(trans('app.Category Information')); ?>
                    ...
                    <div class="card-body">
                        <div class="text-center">
                            <div class="mb-3">
                                <i class="fas fa-folder fs-1 text-primary mb-2"></i>
                                <h6><?php echo e($article->category->name ?? trans('app.No Category')); ?></h6>
                                <p class="text-muted small mb-0"><?php echo e($article->category->description ?? trans('app.No Description')); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="row mt-4">
        <div class="col-12">
            <div class="card border-danger">
                ...
                <div class="card-body">
                    <p class="text-muted mb-3"><?php echo e(trans('app.Delete Article Warning')); ?></p>
                    <form method="post" action="<?php echo e(route('admin.kb-articles.destroy', $article)); ?>" 
                          data-confirm="delete-article">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('DELETE'); ?>
                        <button type="submit" class="btn btn-outline-danger">
                            <i class="fas fa-trash me-1"></i><?php echo e(trans('app.Delete Article')); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp1\htdocs\my-logos\resources\views\admin\kb\articles\edit.blade.php ENDPATH**/ ?>
...
<div class="container-fluid products-form">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h1 class="h3 mb-1 text-dark">
                                ...
                                <?php echo e(trans('app.Create KB Category')); ?>

                            </h1>
                            <p class="text-muted mb-0"><?php echo e(trans('app.Add New Knowledge Base Category')); ?></p>
                        </div>
                        <div>
    ...
    <form method="post" action="<?php echo e(route('admin.kb-categories.store')); ?>" class="needs-validation" novalidate>
        <?php echo csrf_field(); ?>
                    ...
                    <div class="card-body">
                        <div class="text-center">
                            <div id="category-preview" class="p-3 rounded border">
                                <i class="<?php echo e(old('icon', 'fas fa-folder')); ?> fs-1 text-primary mb-2"></i>
                                <h5 id="preview-name"><?php echo e(trans('app.Category Name')); ?></h5>
                                <p id="preview-description" class="text-muted small mb-0"><?php echo e(trans('app.Category Description')); ?></p>
                            </div>
...
unset($__errorArgs, $__bag); ?>" 
                                   id="icon" name="icon" value="<?php echo e(old('icon', 'fas fa-folder')); ?>" 
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="text-center">
                            <div id="icon-preview" class="fs-1 text-primary">
                                <i class="<?php echo e(old('icon', 'fas fa-folder')); ?>"></i>
                            </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp1\htdocs\my-logos\resources\views\admin\kb\categories\create.blade.php ENDPATH**/ ?>
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h1 class="h3 mb-1 text-dark">
                                ...
                                <?php echo e(trans('app.Create Product Category')); ?>

                            </h1>
                            <p class="text-muted mb-0"><?php echo e(trans('app.Add New Product Category')); ?></p>
        </div>
                        <div>
...
<?php endif; ?>
    ...
    <form method="post" action="<?php echo e(route('admin.product-categories.store')); ?>" enctype="multipart/form-data" class="needs-validation" novalidate>
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp1\htdocs\my-logos\resources\views\admin\product-categories\create.blade.php ENDPATH**/ ?>
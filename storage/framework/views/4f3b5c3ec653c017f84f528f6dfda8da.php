                        ...
                        <div class="user-stat-card flex-column h-100">
                            ...
                            <div class="user-stat-header">
                                <div class="user-stat-title">
                                    <?php echo e(is_array($file) ? ($file['original_name'] ?? 'Unknown') : ($file->original_name ?? 'Unknown')); ?>
                            ...
                            <div class="flex-1 flex-column">
                                ...
                                <div class="user-stat-value">
                                    ...
                                    ?>
                                    <?php echo e($formattedSize ?? number_format($fileSize / 1024 / 1024, 2) . ' MB'); ?>

                                </div>
                                <p class="fs-14 text-gray-500 margin-0">
                                    <?php echo e(strtoupper($fileExtension)); ?> <?php echo e(trans('app.File')); ?>
                                ...
                                <?php if($fileDescription): ?>
                                    <div class="mt-12">
                                        <p class="fs-12 text-gray-400 margin-0"><?php echo e(Str::limit($fileDescription, 80)); ?></p>
                                    </div>
                                <?php endif; ?>
                            </div>
                            ...
                            <div class="mt-auto">
                                ...
                                <div class="mt-12 d-flex justify-content-between fs-12 text-gray-500">
                                    ...
                                    ?>
                                    <span><i class="fas fa-download mr-4"></i><?php echo e($downloadCount); ?> <?php echo e(trans('app.Downloads')); ?></span>
                                    <span><i class="fas fa-calendar mr-4"></i><?php echo e($createdAt ? (is_string($createdAt) ? $createdAt : $createdAt->format('M d, Y')) : 'N/A'); ?></span>
                                </div>
                                ...
                                <div class="mt-3">
                                    <?php if(isset($file->is_update) && $file->is_update): ?>
                                        <?php if(isset($file->update_info) && $file->update_info->file_path): ?>
                                            <a href="<?php echo e(route('user.products.files.download-update', [$product, $file->update_info->id])); ?>" 
                                               ...
                                               title="<?php echo e(trans('app.Download Update')); ?> <?php echo e(is_array($file) ? ($file['original_name'] ?? 'Unknown') : ($file->original_name ?? 'Unknown')); ?>">
                                                <i class="fas fa-sync-alt"></i>
                                    ...
                                    <?php else: ?>
                                        ...
                                        ?>
                                        <?php if($fileId): ?>
                                            <a href="<?php echo e(route('user.product-files.download', $fileId)); ?>" 
                                               class="user-action-button"
                                               title="<?php echo e(trans('app.Download')); ?> <?php echo e(is_array($file) ? ($file['original_name'] ?? 'Unknown') : ($file->original_name ?? 'Unknown')); ?>">
                                                <i class="fas fa-download"></i>

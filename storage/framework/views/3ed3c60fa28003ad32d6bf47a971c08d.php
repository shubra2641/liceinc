...
unset($__errorArgs, $__bag); ?>
                        ...
                        <?php if($registrationSettings['enableHumanQuestion']): ?>
                            <div class="form-field-group">
                                <label for="human_answer" class="form-label">
                                    <i class="fas fa-question"></i>
                                    <?php echo e($registrationSettings['selectedQuestionText'] ?? 'Please answer the question'); ?>
...
<?php if($registrationSettings['enableCaptcha'] && $registrationSettings['captchaSiteKey']): ?>
    ...
    <?php $__env->stopPush(); ?>
<?php endif; ?>
<?php echo $__env->make('layouts.user', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\my-logos\resources\views/auth/register.blade.php ENDPATH**/ ?>
    ...
    <div class="user-card">
        ...
        <div class="user-card-content">
            ...
            <div id="licenseCheckFormCard" class="user-card">
                ...
                <div class="user-card-content">
                    <form id="licenseCheckForm" class="register-form license-status-form" action="<?php echo e(route('license.status.check')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                ...
                <div class="user-card-content">
                    ...
                    <div class="license-details-grid">
                        ...
                        <div id="envatoStatus" class="license-info-card">
                            <div class="license-info-header">
                                ...
                                <div class="license-info-title">
                                    <h3><?php echo e(trans('app.envato_status')); ?></h3>
                                    <p id="envatoSubtitle"><?php echo e(trans('app.envato_details_subtitle')); ?></p>
                                </div>
                            </div>
                            <div class="license-info-content">
                                ...
                                <div id="envatoData" class="envato-data-section">
                                    ...
                                    <div class="license-info-row">
                                        <div class="license-info-label">
                                            ...
                                            <?php echo e(trans('app.purchase_date')); ?>
                                ...
                                <div id="envatoNA" class="envato-na-section">
                                    <div class="envato-na-content">
                                        ...
                                        <div class="envato-na-text">
                                            <h4><?php echo e(trans('app.Not Available')); ?></h4>
                                            <p><?php echo e(trans('app.license_from_our_system')); ?></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="license-info-card">
                        <div class="license-info-header">
                            ...
                            <div class="license-info-title">
                                <h3><?php echo e(trans('app.registered_domains')); ?></h3>
                                <p><?php echo e(trans('app.domains_info')); ?></p>
                            </div>
                        </div>
                        <div class="license-info-content">
                                ...
                                <div class="domain-item">
                                    ...
                                    <div class="domain-actions">
                                        <button class="domain-action-btn" data-domain="example.com">
                                            ...
                                            <?php echo e(trans('app.view_history')); ?>
                    ...
                    <div class="license-info-card">
                        <div class="license-info-header">
                            ...
                            <div class="license-info-title">
                                <h3><?php echo e(trans('app.Quick Actions')); ?></h3>
                                <p><?php echo e(trans('app.manage_your_license')); ?></p>
                            </div>
                        </div>
                        <div class="license-info-content">
                            <div class="action-buttons-grid">
                                <button id="viewHistoryBtn" class="action-button primary">
                                    ...
                                    <div class="action-button-content">
                                        <h4><?php echo e(trans('app.view_history')); ?></h4>
                                        <p><?php echo e(trans('app.view_license_history')); ?></p>
                                    </div>
                                </button>
                                <button class="check-another-btn action-button secondary">
                                    ...
                                    <div class="action-button-content">
                                        <h4><?php echo e(trans('app.Check Another License')); ?></h4>
                                        <p><?php echo e(trans('app.verify_another_license')); ?></p>
                                    </div>
                                </button>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.user', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\my-logos\resources\views/license-status.blade.php ENDPATH**/ ?>
...
<head>
    ...
    <meta name="description" content="<?php echo $__env->yieldContent('meta_description', $siteSeoDescription ?? 'Admin dashboard for managing licenses and products'); ?>">
        ...
        <div class="admin-sidebar-container">
            ...
            <div class="admin-sidebar-header">
                <div class="admin-sidebar-logo">
                    <?php if($siteLogo): ?>
                        <img src="<?php echo e(Storage::url($siteLogo)); ?>" alt="<?php echo e($siteName); ?>" class="admin-sidebar-logo-icon" />
                    <?php else: ?>
            ...
            <nav class="admin-sidebar-nav">
                ...
                <div class="nav-section">
                    ...
                    <a href="<?php echo e(route('admin.clear-cache')); ?>" class="admin-nav-item" onclick="return confirm('Are you sure you want to clear all caches?')">
            ...
            <div class="admin-sidebar-footer">
                ...
                <div class="admin-footer-quick d-flex justify-content-between align-items-center mb-2 px-2">
                    ...
                    <a href="<?php echo e(route('lang.switch', $otherLanguage['code'])); ?>" class="admin-footer-link text-decoration-none text-muted">
                        <?php echo e($otherLanguage['native_name']); ?>

                    </a>
                    <?php endif; ?>
                    <a href="<?php echo e(route('admin.profile.edit')); ?>" class="admin-footer-link text-decoration-none text-muted">
                ...
                <div class="admin-user-profile">
                    ...
                    <div class="admin-user-dropdown">
                        ...
                        <div class="admin-user-dropdown-menu">
                            <a href="<?php echo e(route('admin.profile.edit')); ?>" class="admin-user-dropdown-item profile"><?php echo e(trans('app.Profile')); ?></a>
                            <a href="<?php echo e(route('admin.settings.index')); ?>" class="admin-user-dropdown-item settings"><?php echo e(trans('app.Settings')); ?></a>
                            <a href="<?php echo e(route('logout')); ?>" class="admin-user-dropdown-item danger logout" data-action="logout"><?php echo e(trans('app.Logout')); ?></a>
                        </div>
                    </div>
                </div>
                <?php endif; ?>
...
<?php echo $__env->make('components.UpdateNotification', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    <?php if(request()->routeIs('admin.dashboard*') || request()->routeIs('admin.reports*') || request()->routeIs('admin.products.logs')): ?>
    ...
    <script src="<?php echo e(asset('assets/admin/js/updates.js')); ?>"></script>
    <?php endif; ?>
...
</html><?php /**PATH D:\xampp\htdocs\my-logos\resources\views/layouts/admin.blade.php ENDPATH**/ ?>
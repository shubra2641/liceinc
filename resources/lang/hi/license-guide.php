...
return [
    ...
    // Overview Section
    'overview' => 'अवलोकन',
    'overview_description' => 'यह गाइड बताता है कि हमारे सुरक्षित लाइसेंस सत्यापन सिस्टम का उपयोग करके अपने एप्लिकेशन में लाइसेंस सत्यापन कैसे लागू करें। सिस्टम यह सुनिश्चित करने के लिए हमारे लाइसेंस सर्वर के खिलाफ रियल-टाइम सत्यापन प्रदान करता है कि केवल वैध लाइसेंस ही आपके सॉफ़्टवेयर का उपयोग कर सकते हैं।',
    ...
    'step_1_description' => 'अपने एडमिन पैनल से लाइसेंस सत्यापन फ़ाइल डाउनलोड करें या नवीनतम संस्करण प्राप्त करने के लिए सहायता से संपर्क करें।',
    'download_command' => 'डाउनलोड कमांड',

    'step_2_title' => 'चरण 2: अपने सर्वर पर अपलोड करें',
    'step_2_description' => 'सत्यापन फ़ाइल को अपने सर्वर पर अपलोड करें। सुरक्षा कारणों से, हम इसे गैर-वेब सुलभ निर्देशिका में रखने की सलाह देते हैं।',

...
return [
    ...
    // Overview Section
    'overview' => 'نظرة عامة',
    'overview_description' => 'يشرح هذا الدليل كيفية تنفيذ التحقق من الترخيص في تطبيقاتك باستخدام نظام التحقق الآمن من الترخيص. '.
        'يوفر النظام التحقق في الوقت الفعلي ضد خادم الترخيص الخاص بنا '.
        'لضمان أن التراخيص الصالحة فقط يمكنها استخدام برنامجك.',

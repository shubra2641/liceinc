...
<div class="user-dashboard-container">
            ...
            <div class="category-purchase-hero">
                <div class="category-purchase-hero-content">
                    ...
                    <div class="category-purchase-hero-text">
                        <h1 class="category-purchase-hero-title">{{ $category->name }}</h1>
                        @if(!empty($category->description))
                        <p class="category-purchase-hero-subtitle">{{ $category->description }}</p>
                        @endif
                    </div>
    ...
    <div class="license-verification-card">
        <div class="license-verification-header">
            ...
            <div class="license-verification-title-section">
                ...
                <p class="license-verification-subtitle">
                    @if(!empty($category->purchase_message))
                    {{ $category->purchase_message }}
                    @else
        ...
        <div class="license-verification-content">
            ...
            <form method="GET" action="{{ route('kb.category', $category->slug) }}" class="license-verification-form">
        ...
        <div class="user-card-header">
            <div class="user-section-header">
                <div class="user-section-title">
                    ...
                    <div>
                        <h3 class="user-section-title-text">{{ trans('app.Category Information') }}</h3>
                        <p class="user-section-subtitle">{{ trans('app.About this category') }}</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="category-info-grid">
                <div class="category-info-item">
                    ...
                    <div class="info-content">
                        <div class="info-label">{{ trans('app.Category Name') }}</div>
                ...
                <div class="category-info-item">
                    ...
                    <div class="info-content">
                        <div class="info-label">{{ trans('app.Description') }}</div>
                ...
                <div class="category-info-item">
                    ...
                    <div class="info-content">
                        ...
                        <div class="info-value">{{ $category->created_at->format('M d, Y') }}</div>
                    </div>
                </div>
            </div>
        </div>

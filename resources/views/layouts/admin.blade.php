...
<head>
    ...
    <meta name="description"
        content="@yield('meta_description', $siteSeoDescription ?? 'Admin dashboard for managing licenses and products')">
            ...
            <div class="admin-sidebar-container">
                ...
                <nav class="admin-sidebar-nav">
                    ...
                    <div class="nav-section">
                        ...
                        <a href="{{ route('admin.clear-cache') }}" class="admin-nav-item"
                ...
                <div class="admin-sidebar-footer">
                    ...
                    <div class="admin-footer-quick d-flex justify-content-between align-items-center mb-2 px-2">
                        @if($otherLanguage)
                        <a href="{{ route('lang.switch', $otherLanguage['code']) }}"
                        ...
                        <div class="admin-user-profile">
                            ...
                            <div class="admin-user-dropdown">
                                ...
                                <div class="admin-user-dropdown-menu">
                                    <a href="{{ route('admin.profile.edit') }}"
                                        class="admin-user-dropdown-item profile">{{ trans('app.Profile') }}</a>
                                    <a href="{{ route('admin.settings.index') }}"
                                        class="admin-user-dropdown-item settings">{{ trans('app.Settings') }}</a>
                                    <a href="{{ route('logout') }}" class="admin-user-dropdown-item danger logout"
                                        data-action="logout">{{ trans('app.Logout') }}</a>
                                </div>
                            </div>
                        </div>
                        @endauth

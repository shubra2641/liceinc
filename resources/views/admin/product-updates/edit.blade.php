...
@section('title', trans('app.Edit Product Update'))
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h1 class="h3 mb-1 text-dark">
                                ...
                                {{ trans('app.Edit Product Update') }}
                            </h1>
                            <p class="text-muted mb-0">{{ $productUpdate->title }} - {{ $productUpdate->version }}</p>
                        </div>
                        <div class="d-flex gap-2">
                            <a href="{{ route('admin.product-updates.show', $productUpdate) }}" class="btn btn-outline-info">
                                <i class="fas fa-eye me-1"></i>
                                {{ trans('app.View Update') }}
                            </a>
    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.product-updates.update', $productUpdate) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <input type="hidden" name="product_id" value="{{ $productUpdate->product_id }}">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('version') is-invalid @enderror" 
                                       id="version" name="version" value="{{ old('version', $productUpdate->version) }}" 
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('title') is-invalid @enderror" 
                                       id="title" name="title" value="{{ old('title', $productUpdate->title) }}" 
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      ...
                                      placeholder="Brief description of the update">{{ old('description', $productUpdate->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('changelog') is-invalid @enderror" 
                                      ...
                                      placeholder="Enter changelog items, one per line...">{{ old('changelog', $productUpdate->changelog_text) }}</textarea>
                            <div class="form-text">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="is_major" name="is_major" value="1" {{ old('is_major', $productUpdate->is_major) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-4 mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="is_required" name="is_required" value="1" {{ old('is_required', $productUpdate->is_required) ? 'checked' : '' }}>
                            ...
                            <div class="col-md-4 mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="is_active" name="is_active" value="1" {{ old('is_active', $productUpdate->is_active) ? 'checked' : '' }}>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="datetime-local" class="form-control @error('released_at') is-invalid @enderror" 
                                   ...
                                   value="{{ old('released_at', $productUpdate->released_at?->format('Y-m-d\TH:i')) }}">
                            @error('released_at')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-text">
                                {{ trans('app.Upload a new ZIP file to replace the current package') }}
                                @if($productUpdate->file_name)
                                    <br><strong>{{ trans('app.Current file') }}:</strong> {{ $productUpdate->file_name }}
                                @endif
                            </div>
                            @error('update_file')
                                <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a href="{{ route('admin.product-updates.show', $productUpdate) }}" class="btn btn-outline-secondary">
                                {{ trans('app.Cancel') }}
                            </a>
                        </div>
                    </form>
            ...
            <div class="card mt-4">
                <div class="card-header bg-warning text-dark">
                    <h5 class="card-title mb-0">
                        ...
                        {{ trans('app.Current Package') }}
                    </h5>
                </div>
                <div class="card-body">
                    <div class="mb-3">
                        <label class="form-label fw-bold">{{ trans('app.File Name') }}</label>
                        <p class="form-control-plaintext">{{ $productUpdate->file_name ?? 'N/A' }}</p>
                    </div>
                    <div class="mb-3">
                        <label class="form-label fw-bold">{{ trans('app.File Size') }}</label>
                        <p class="form-control-plaintext">{{ $productUpdate->formatted_file_size ?? 'N/A' }}</p>
                    </div>
                    <a href="{{ route('admin.product-updates.download', $productUpdate) }}" class="btn btn-outline-info btn-sm">
                        <i class="fas fa-download me-1"></i>
                        {{ trans('app.Download Current Package') }}
                    </a>
                </div>
            </div>
            @endif

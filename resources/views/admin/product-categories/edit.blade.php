...
<div class="container-fluid products-form">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h1 class="h3 mb-1 text-dark">
                                ...
                                {{ trans('app.Edit Product Category') }}
                            </h1>
                            <p class="text-muted mb-0">{{ $product_category->name }}</p>
                        </div>
                        <div>
    ...
    <form method="post" action="{{ route('admin.product-categories.update', $product_category) }}" enctype="multipart/form-data" class="needs-validation" novalidate>
        @csrf
        @method('PUT')
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror" 
                                       id="name" name="name" value="{{ old('name', $product_category->name) }}" 
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('slug') is-invalid @enderror" 
                                       id="slug" name="slug" value="{{ old('slug', $product_category->slug) }}" 
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      ...
                                      placeholder="{{ trans('app.Enter Category Description') }}">{{ old('description', $product_category->description) }}</textarea>
                            <div class="form-text">
                                <i class="fas fa-info-circle me-1"></i>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="mt-2">
                                    <img src="{{ Storage::url($product_category->image) }}" alt="{{ trans('app.Current Image') }}" 
                                         class="img-thumbnail category-image">
                                    <p class="text-muted small mt-1">{{ trans('app.Leave empty to keep current image') }}</p>
                                </div>
                                @endif
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control @error('sort_order') is-invalid @enderror" 
                                       id="sort_order" name="sort_order" value="{{ old('sort_order', $product_category->sort_order) }}" 
                                       min="0" placeholder="0">
                        ...
                        <div class="form-check form-switch mb-3">
                            <input class="form-check-input" type="checkbox" id="is_active" name="is_active" value="1"
                                   {{ old('is_active', $product_category->is_active) ? 'checked' : '' }}>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('meta_title') is-invalid @enderror" 
                                       id="meta_title" name="meta_title" value="{{ old('meta_title', $product_category->meta_title) }}" 
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('meta_keywords') is-invalid @enderror" 
                                       id="meta_keywords" name="meta_keywords" value="{{ old('meta_keywords', $product_category->meta_keywords) }}" 
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('meta_description') is-invalid @enderror" 
                                      ...
                                      maxlength="500" placeholder="{{ trans('app.SEO Description Placeholder') }}">{{ old('meta_description', $product_category->meta_description) }}</textarea>
                    ...
                    <div class="card-body">
                        <div class="form-check form-switch mb-3">
                            <input class="form-check-input" type="checkbox" id="show_in_menu" name="show_in_menu" value="1"
                                   {{ old('show_in_menu', $product_category->show_in_menu ?? true) ? 'checked' : '' }}>
                        ...
                        <div class="form-check form-switch mb-3">
                            <input class="form-check-input" type="checkbox" id="is_featured" name="is_featured" value="1"
                                   {{ old('is_featured', $product_category->is_featured ?? false) ? 'checked' : '' }}>
                        ...
                        <div class="row text-center">
                            <div class="col-6 mb-3">
                                <div class="stats-card">
                                    <h4 class="text-primary">{{ $product_category->products()->count() }}</h4>
                                    <p class="text-muted small mb-0">{{ trans('app.Products') }}</p>
                                </div>
                            </div>
                            <div class="col-6 mb-3">
                                <div class="stats-card">
                                    <h4 class="text-info">{{ $product_category->created_at->format('M Y') }}</h4>
                                    <p class="text-muted small mb-0">{{ trans('app.Created') }}</p>
                                </div>
                            </div>
                            <div class="col-6 mb-3">
                                <div class="stats-card">
                                    <h4 class="text-warning">{{ $product_category->updated_at->format('M Y') }}</h4>
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="color" class="form-control form-control-color @error('color') is-invalid @enderror" 
                                   id="color" name="color" value="{{ old('color', $product_category->color ?? '#007bff') }}">
                            @error('color')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="color" class="form-control form-control-color @error('text_color') is-invalid @enderror" 
                                   id="text_color" name="text_color" value="{{ old('text_color', $product_category->text_color ?? '#ffffff') }}">
                            @error('text_color')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('icon') is-invalid @enderror" 
                                   id="icon" name="icon" value="{{ old('icon', $product_category->icon ?? 'fas fa-folder') }}" 
                        ...
                        <div class="text-center">
                            <div id="icon-preview" class="fs-1 text-primary">
                                <i class="{{ $product_category->icon ?? 'fas fa-folder' }}"></i>
                            </div>
        ...
        <div class="col-12">
            <div class="card border-danger">
                ...
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('admin.product-categories.destroy', $product_category) }}" 

            ...
            <div class="dashboard-grid dashboard-grid-4 stats-grid-enhanced">
                ...
                <div class="stats-card stats-card-primary animate-slide-up">
                    ...
                    <div class="stats-card-content">
                        ...
                        <div class="stats-card-body">
                            <div class="stats-card-value">{{ number_format($totalLicenses) }}</div>
                            <div class="stats-card-label">{{ trans('app.Total_licenses') }}</div>
                            <div class="stats-card-trend positive">
                                <i class="stats-trend-icon positive"></i>
                                <span>+12% {{ trans('app.from_last_month') }}</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="stats-card stats-card-success animate-slide-up animate-delay-200">
                    ...
                    <div class="stats-card-content">
                        ...
                        <div class="stats-card-body">
                            <div class="stats-card-value">{{ number_format($activeLicenses) }}</div>
                ...
                <div class="stats-card stats-card-warning animate-slide-up animate-delay-300">
                    ...
                    <div class="stats-card-content">
                        ...
                        <div class="stats-card-body">
                            <div class="stats-card-value">{{ number_format($expiredLicenses) }}</div>
                ...
                <div class="stats-card stats-card-danger animate-slide-up animate-delay-400">
                    ...
                    <div class="stats-card-content">
                        ...
                        <div class="stats-card-body">
                            <div class="stats-card-value">{{ $rateLimitedIPs->count() }}</div>
                            <div class="stats-card-label">{{ trans('app.blocked_ips') }}</div>
                            <div class="stats-card-trend negative">
                                <i class="stats-trend-icon negative"></i>
                                <span>{{ trans('app.security_protection') }}</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="dashboard-grid dashboard-grid-3 stats-grid-enhanced mb-4">
                ...
                <div class="stats-card stats-card-success animate-slide-up">
                    ...
                    <div class="stats-card-content">
                        ...
                        <div class="stats-card-body">
                            <div class="stats-card-value">${{ number_format($invoiceStatusTotals['paid'] ?? 0, 2) }}</div>
                            <div class="stats-card-label">{{ trans('app.Total Paid Amount') }}</div>
                            <div class="stats-card-trend positive">
                                <i class="stats-trend-icon positive"></i>
                                <span>+8.2% {{ trans('app.from_last_month') }}</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="stats-card stats-card-warning animate-slide-up animate-delay-200">
                    ...
                    <div class="stats-card-content">
                        ...
                        <div class="stats-card-body">
                            <div class="stats-card-value">${{ number_format($invoiceStatusTotals['due_soon'] ?? 0, 2) }}</div>
                            <div class="stats-card-label">{{ trans('app.Due Soon Amount') }}</div>
                            <div class="stats-card-trend negative">
                                <i class="stats-trend-icon negative"></i>
                                <span>{{ trans('app.requires_attention') }}</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="stats-card stats-card-danger animate-slide-up animate-delay-300">
                    ...
                    <div class="stats-card-content">
                        ...
                        <div class="stats-card-body">
                            <div class="stats-card-value">${{ number_format($invoiceStatusTotals['cancelled'] ?? 0, 2) }}</div>
                            <div class="stats-card-label">{{ trans('app.Cancelled/Unpaid Amount') }}</div>
                            <div class="stats-card-trend negative">
                                <i class="stats-trend-icon negative"></i>
                                <span>-2.1% {{ trans('app.from_last_month') }}</span>
                            </div>
                        </div>
                    </div>
                </div>

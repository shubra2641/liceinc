...
<div class="container-fluid products-form">
    ...
    <form method="post" action="{{ route('admin.kb-articles.update', $article) }}" enctype="multipart/form-data" class="needs-validation" novalidate>
        @csrf
        @method('PUT')
            ...
            <div class="col-lg-8">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('kb_category_id') is-invalid @enderror" 
                                    ...
                                    <option value="{{ $id }}" 
                                        {{ old('kb_category_id', $article->kb_category_id) == $id ? 'selected' : '' }}>
                                        {{ $name }}
                                    </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('excerpt') is-invalid @enderror" 
                                      ...
                                      placeholder="{{ trans('app.Brief summary of article') }}">{{ old('excerpt', $article->excerpt) }}</textarea>
                            <div class="form-text">
                                <i class="fas fa-info-circle me-1"></i>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        @if($article->image)
                        <div class="mb-3">
                            <label class="form-label">{{ trans('app.Current Featured Image') }}</label>
                        ...
                        <div class="mb-3">
                            <label for="image" class="form-label">
                                ...
                                {{ $article->image ? trans('app.Change Featured Image') : trans('app.Featured Image') }}
                            </label>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('content') is-invalid @enderror" 
                                      ...
                                      placeholder="{{ trans('app.Enter Article Content') }}" required>{{ old('content', $article->content) }}</textarea>
                            <div class="form-text">
                                <i class="fas fa-info-circle me-1"></i>
                    ...
                    <div class="card-body">
                        <div class="form-check form-switch mb-3">
                            <input class="form-check-input" type="checkbox" id="requires_serial" name="requires_serial" value="1"
                                   {{ old('requires_serial', $article->requires_serial) ? 'checked' : '' }}>
                        ...
                        <div id="serial-fields" class="{{ old('requires_serial', $article->requires_serial) ? 'visible-field' : 'hidden-field' }}">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('serial') is-invalid @enderror" 
                                       id="serial" name="serial" value="{{ old('serial', $article->serial) }}" 
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('serial_message') is-invalid @enderror" 
                                          ...
                                          placeholder="{{ trans('app.Message shown when serial required') }}">{{ old('serial_message', $article->serial_message) }}</textarea>
                                <div class="form-text">
                                    <i class="fas fa-info-circle me-1"></i>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('meta_description') is-invalid @enderror" 
                                      ...
                                      maxlength="500" placeholder="{{ trans('app.SEO Description Placeholder') }}">{{ old('meta_description', $article->meta_description) }}</textarea>
                    ...
                    <div class="card-body">
                        <div class="text-center">
                            <div id="article-preview" class="p-3 rounded border">
                                ...
                                <h5 id="preview-title">{{ $article->title }}</h5>
                                <p id="preview-excerpt" class="text-muted small mb-0">{{ $article->excerpt ?: trans('app.Article Excerpt') }}</p>
                            </div>
                        ...
                        <div class="row text-center">
                            <div class="col-6 mb-3">
                                <div class="stats-card">
                                    ...
                                    <p class="text-muted small mb-0">{{ trans('app.Views') }}</p>
                                </div>
                            </div>
                            <div class="col-6 mb-3">
                                <div class="stats-card">
                                    <h4 class="text-success">{{ $article->likes ?? 0 }}</h4>
                                    <p class="text-muted small mb-0">{{ trans('app.Likes') }}</p>
                                </div>
                            </div>
                            <div class="col-6 mb-3">
                                <div class="stats-card">
                                    <h4 class="text-info">{{ $article->created_at->format('M Y') }}</h4>
                                    <p class="text-muted small mb-0">{{ trans('app.Created') }}</p>
                                </div>
                            </div>
                            <div class="col-6 mb-3">
                                <div class="stats-card">
                                    <h4 class="text-warning">{{ $article->updated_at->format('M Y') }}</h4>
                ...
                <div class="card mb-4">
                    <div class="card-header bg-primary text-white">
                        <h5 class="card-title mb-0">
                            ...
                            {{ trans('app.Category Information') }}
                        </h5>
                    </div>
                    <div class="card-body">
                        <div class="text-center">
                            <div class="mb-3">
                                ...
                                <h6>{{ $article->category->name ?? trans('app.No Category') }}</h6>
                                <p class="text-muted small mb-0">{{ $article->category->description ?? trans('app.No Description') }}</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="row mt-4">
        <div class="col-12">
            <div class="card border-danger">
                ...
                <div class="card-body">
                    <p class="text-muted mb-3">{{ trans('app.Delete Article Warning') }}</p>
                    <form method="post" action="{{ route('admin.kb-articles.destroy', $article) }}" 
                          data-confirm="delete-article">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="btn btn-outline-danger">
                            <i class="fas fa-trash me-1"></i>{{ trans('app.Delete Article') }}
                        </button>
                    </form>
                </div>
            </div>

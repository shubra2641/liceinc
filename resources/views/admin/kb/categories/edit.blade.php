...
<div class="container-fluid products-form">
    ...
    <form method="post" action="{{ route('admin.kb-categories.update', $category) }}" class="needs-validation" novalidate>
        @csrf
        @method('PUT')
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      ...
                                      placeholder="{{ trans('app.Enter Category Description') }}">{{ old('description', $category->description) }}</textarea>
                            <div class="form-text">
                                <i class="fas fa-info-circle me-1"></i>
                    ...
                    <div class="card-body">
                        <div class="form-check form-switch mb-3">
                            ...
                            <input class="form-check-input" type="checkbox" id="requires_serial" name="requires_serial" value="1"
                                   {{ old('requires_serial', $category->requires_serial) ? 'checked' : '' }}>
                        ...
                        <div id="serial-fields" class="{{ old('requires_serial', $category->requires_serial) ? 'visible-field' : 'hidden-field' }}">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('serial') is-invalid @enderror" 
                                       id="serial" name="serial" value="{{ old('serial', $category->serial) }}" 
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('serial_message') is-invalid @enderror" 
                                          ...
                                          placeholder="{{ trans('app.Message shown when serial required') }}">{{ old('serial_message', $category->serial_message) }}</textarea>
                                <div class="form-text">
                                    <i class="fas fa-info-circle me-1"></i>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('meta_description') is-invalid @enderror" 
                                      ...
                                      maxlength="500" placeholder="{{ trans('app.SEO Description Placeholder') }}">{{ old('meta_description', $category->meta_description) }}</textarea>
                    ...
                    <div class="card-body">
                        <div class="text-center">
                            <div id="category-preview" class="p-3 rounded border">
                                <i class="{{ old('icon', $category->icon ?? 'fas fa-folder') }} fs-1 text-primary mb-2"></i>
                                <h5 id="preview-name">{{ $category->name }}</h5>
                                <p id="preview-description" class="text-muted small mb-0">{{ $category->description ?: trans('app.Category Description') }}</p>
                            </div>
                        ...
                        <div class="row text-center">
                            <div class="col-6 mb-3">
                                <div class="stats-card">
                                    <h4 class="text-primary">{{ $category->articles_count ?? 0 }}</h4>
                            ...
                            <div class="col-6 mb-3">
                                <div class="stats-card">
                                    <h4 class="text-info">{{ $category->created_at->format('M Y') }}</h4>
                                    <p class="text-muted small mb-0">{{ trans('app.Created') }}</p>
                                </div>
                            </div>
                            <div class="col-6 mb-3">
                                <div class="stats-card">
                                    <h4 class="text-warning">{{ $category->updated_at->format('M Y') }}</h4>
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('icon') is-invalid @enderror" 
                                   id="icon" name="icon" value="{{ old('icon', $category->icon ?? 'fas fa-folder') }}" 
        ...
        <div class="col-12">
            <div class="card border-danger">
                ...
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('admin.kb-categories.destroy', $category) }}" 

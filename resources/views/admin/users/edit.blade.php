                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="password" class="form-control @error('password') is-invalid @enderror" 
                                       ...
                                       placeholder="{{ trans('app.Leave empty to keep current password') }}">
                                <div class="form-text">
                                    <i class="fas fa-info-circle me-1"></i>
                                    {{ trans('app.Leave empty to keep current password') }}
                                </div>
                                @error('password')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="password" class="form-control @error('password_confirmation') is-invalid @enderror" 
                                       ...
                                       placeholder="{{ trans('app.Confirm new password') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('companyname') is-invalid @enderror" 
                                       id="companyname" name="companyname" value="{{ old('companyname', $user->companyname) }}" 
                    ...
                    <div class="card-body">
                        <div class="text-center">
                            <div id="user-preview" class="p-3 rounded border">
                                ...
                                <h5 id="preview-name">{{ $user->name }}</h5>
                                <p id="preview-email" class="text-muted small mb-0">{{ $user->email }}</p>
                                <span id="preview-role" class="badge bg-{{ $user->role == 'admin' ? 'danger' : 'secondary' }} mt-2">
                        ...
                        <div class="row text-center">
                            <div class="col-6 mb-3">
                                <div class="stats-card">
                                    <h4 class="text-primary">{{ $user->licenses_count ?? 0 }}</h4>
                                    <p class="text-muted small mb-0">{{ trans('app.Licenses') }}</p>
                                </div>
                            </div>
                            <div class="col-6 mb-3">
                                <div class="stats-card">
                                    <h4 class="text-success">{{ $user->invoices_count ?? 0 }}</h4>
                                    <p class="text-muted small mb-0">{{ trans('app.Invoices') }}</p>
                                </div>
                            </div>
                            <div class="col-6 mb-3">
                                <div class="stats-card">
                                    <h4 class="text-info">{{ $user->tickets_count ?? 0 }}</h4>
                                    <p class="text-muted small mb-0">{{ trans('app.Tickets') }}</p>
                                </div>
                            </div>
                            <div class="col-6 mb-3">
                                <div class="stats-card">
                                    <h4 class="text-warning">{{ $user->orders_count ?? 0 }}</h4>
                    ...
                    <div class="card-body">
                        <div class="form-check form-switch mb-3">
                            <input class="form-check-input" type="checkbox" id="is_active" name="is_active" value="1"
                                   {{ old('is_active', $user->status === 'active') ? 'checked' : '' }}>
    ...
    <div class="row mt-4">
        <div class="col-12">
            <div class="card border-danger">
                ...
                <div class="card-body">
                    <p class="text-muted mb-3">{{ trans('app.Delete User Warning') }}</p>
                    <form method="post" action="{{ route('admin.users.destroy', $user) }}" 
                          data-confirm="delete-user">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="btn btn-outline-danger">
                            <i class="fas fa-trash me-1"></i>{{ trans('app.Delete User') }}
                        </button>
                    </form>
                </div>
            </div>
